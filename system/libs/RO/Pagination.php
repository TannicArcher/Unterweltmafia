<?php
	...
	class Pagination
	{
		...
		function GetPageLinks()
		{
			...
			{
				$links .= $begin / $this->per_page <= 1 ? '<span class="prev">zurück</span> ' : '<a href="'.$this->GetLinkHref($this->current_page-1).'" class="prev">zurück</a> ';
				...
				$links .= $this->current_page >= $this->GetNumPages() ? '<span class="next">weiter</span>' : '<a href="'.$this->GetLinkHref($this->current_page+1).'" class="next">weiter</a>';
			}
